...
var importData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var createdUsers, adminID_1, sampleProducts, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, user_2.default.deleteMany({})];
            case 3:
                _a.sent();
                return [4 /*yield*/, user_2.default.insertMany(user_1.default)];
            case 4:
                createdUsers = _a.sent();
                adminID_1 = createdUsers[0]._id;
                sampleProducts = products_1.default.map(function (product) {
                    return __assign(__assign({}, product), { user: adminID_1 });
                });
                return [4 /*yield*/, product_1.default.insertMany(sampleProducts)];
            case 5:
                _a.sent();
                return [3 /*break*/, 7];
            case 6:
